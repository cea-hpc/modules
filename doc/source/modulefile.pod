...
load, unload, remove, switch, display, help or whatis.
...
list, whatis, search, purge, restore or help.
...
zsh, csh, tcsh, fish, tcl, perl, python, lisp.
...
can be: sh, csh, fish, tcl, perl, python, lisp.
