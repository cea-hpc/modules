...
#
set MODULES_CURRENT_VERSION 1.559
...
proc module-alias {args} {
   global g_moduleAlias ModulesCurrentModulefile g_debug
      ...
      if {$modfile != ""} {
         ...
         if {$g_force || ! [info exists g_loadedModules($currentModule)]} {
            ...
            if {[execute-modulefile $modfile]} {
               ...
               if {$g_debug} {
                  report "DEBUG cmdModuleLoad: genericModName =\
                     $genericModName"
               }
   ...
   if {$args == ""} {
      ...
      foreach path $args {
         ...
         if {[info exists env(MODULEPATH)] && [regexp $regexp\
            ...
            if {$g_debug} {
               report "calling unload-path MODULEPATH $path\
                  $g_def_separator"
            }
